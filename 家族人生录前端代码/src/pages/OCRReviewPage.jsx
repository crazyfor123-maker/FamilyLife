...
import { OCRFactory, ImagePreprocessor, GenealogyParser, OCRResultCache } from '../utils/OCREngine';
    ...
    try {
      ...
      if (res && res.code === 0) {
        ...
        setResults(MockData.ocrResults || [
          ...
          { id: 2, original: '朱国栋', confidence: 0.92, name: '朱国栋', birth: '1945-06-20', status: 'pending' },
